...
class TestLoadExcelData(unittest.TestCase):
    ...
    def test_load_excel_file(self):
        ...
        file_path = r"C:\Users\krina\OneDrive - Queen Mary, University of London\Desktop\Year2\DAT5902\final_project\test_suite\attp_data.xlsx"
    ...
    def test_load_appt_data_sheet(self):
        ...
        # Load the 'appt_data' sheet using the function to be tested
